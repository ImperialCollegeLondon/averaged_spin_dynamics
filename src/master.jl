...
# ── M8 (resonance-averaged dynamics, B&S Dec-2021 JGCD 44(12) G006058) ──────
# Transcription record + open sign-off items: docs/BS2021_resonance_equations.md.
# NOTE: resonance.jl implements Eq. (A11) locally rather than calling
# tumbling_periods(...)[1], which is affected by [FLAG-PPHI].
...
# ── M3: tumbling-averaged model (layer B) ─────────────────────────────────────
